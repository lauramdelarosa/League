...
public class FragmentLeagueBindingImpl extends FragmentLeagueBinding  {
    ...
    public FragmentLeagueBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private FragmentLeagueBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.delarosa.league.league.LeagueViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.delarosa.league.league.LeagueViewModel ViewModel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewModelList((androidx.lifecycle.MutableLiveData<java.util.List<com.delarosa.domain.League>>) object, fieldId);
            case 1 :
                return onChangeViewModelLoadingProgressBar((androidx.lifecycle.MutableLiveData<java.lang.Boolean>) object, fieldId);
        }
        return false;
    }
    private boolean onChangeViewModelList(androidx.lifecycle.MutableLiveData<java.util.List<com.delarosa.domain.League>> ViewModelList, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        androidx.lifecycle.MutableLiveData<java.util.List<com.delarosa.domain.League>> viewModelList = null;
        ...
        java.util.List<com.delarosa.domain.League> viewModelListGetValue = null;
        com.delarosa.league.league.LeagueViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0xdL) != 0) {
            ...
            com.delarosa.league.league.BindingsAdaptersKt.setLeagues(this.recycler, viewModelListGetValue);
        }
    }
